...
/*
 * MedicalSuppliesMasterPanel.java
 *
 * Created on 2009/08/18, 19:34:03
 */
package open.dolphin.client.editor.medicalsupplies;
 ...
 * @author
 */
public class MedicalSuppliesMasterPanel extends AbstractMasterPanel {
...
//    private static final String[] sortButtonNames = GlobalVariables.getStringArray("masterSearch.medicine.sortButtonNames");
    ...
    /** Creates new form MedicalSuppliesMasterPanel
     * @param master 
     */
    public MedicalSuppliesMasterPanel(String master) {
        super(master);
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(scroller, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 481, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(scroller, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE))
        );
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            MedicineEntry medicine = (MedicineEntry) tableModel.getObject(table.getSelectedRow());
            //    if (medicine != null && medicine.isInUse()) {
            if (medicine != null && (medicine.useState(new GregorianCalendar()) != 2)) {//isInUse()は日付がNULL、Emptyで真を返してしまうので
                MasterItem mItem = new MasterItem(ClaimConst.YAKUZAI, medicine);
                mItem.setUnit(medicine.getUnit());
                mItem.setYkzKbn(medicine.getYkzKbn());
