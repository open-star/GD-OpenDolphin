 ...
 * @author  kazm
 */
public class SchemaDialog extends javax.swing.JDialog {

    /** Creates new form SchemaDialog
     * @param parent
     * @param title
     * @param modal
     */
    public SchemaDialog(java.awt.Frame parent, String title, boolean modal) {
    ...
    private void initComponents() {
        ...
        lineBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/LineOff.gif"))); // NOI18N
        lineBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        rectBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/RectOff.gif"))); // NOI18N
        rectBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        ovalBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/OvalOff.gif"))); // NOI18N
        ovalBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        polyBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/PolyOff.gif"))); // NOI18N
        polyBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        rectFillBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/FillRectOff.gif"))); // NOI18N
        rectFillBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        ovalFillBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/FillOvalOff.gif"))); // NOI18N
        ovalFillBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        polyFillBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/FillPolyOff.gif"))); // NOI18N
        polyFillBtn.setMargin(new java.awt.Insets(4, 4, 3, 3));

        textBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/TextOff.gif"))); // NOI18N
        ...
        undoBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/undo_24.gif"))); // NOI18N
        undoBtn.setToolTipText("やり直しをします。");

        clearBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/remov_24.gif"))); // NOI18N
        ...
        selectBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/open/dolphin/client/schemaeditor/resources/move_24.gif"))); // NOI18N
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(okBtn))
                    .add(org.jdesktop.layout.GroupLayout.LEADING, canvasPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 714, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(canvasPanel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 333, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel1)
