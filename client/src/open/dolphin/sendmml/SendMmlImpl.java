 ...
 */
public class SendMmlImpl implements IMainService { //implements IMmlMessageListener {
    ...
    public void stop() {
        try {
            ...
            moribund.interrupt();
            logDump();
            //     LogWriter.info(getClass(), "Send MML stopped");

        } catch (Exception e) {
            LogWriter.error(getClass(), e);
            //       LogWriter.warn(getClass(), "Exception while stopping the send MML");
    ...
    public void start() {
        ...
        sendThread.start();
        //    LogWriter.info(SendMmlImpl.class, "Send MML statered with CSGW = " + getCSGWPath());
    }
