 ...
 * @author
 */
public class PatientVisitInspectorPlugin implements open.dolphin.plugin.IPlugin {
    ...
    private String getName() {
        return PatientVisitInspector.TITLE;
    }
    ...
    private IChartDocument panel(IChart parent) {
        return new PatientVisitInspector(parent);
    }
